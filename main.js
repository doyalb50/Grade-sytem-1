function findGrade() {
    ...
    document.getElementById('show-result').innerHTML =
        'Bangla: ' + bangla + '<br/> Grade: ' + banglaGrade + '<br/> <br/> English: ' + english +
        '<br/> Grade: ' + englishGrade + '<br/>  <br/> ICT: ' + ict +
        '<br/> Grade: ' + ictGrade + ' <br/> <br/> Physics : ' + physics +
        '<br/> Grade: ' + physicsGrade + '<br/> <br/> Chemistry : ' + chemistry +
        '<br/> Grade: ' + chemistryGrade + ' <br/> <br/> Biology : ' + biology +
        '<br/> Grade: ' + biologyGrade + '<br/> <br/> Higher Math : ' + math +
        '<br/> Grade: ' + mathGrade;
